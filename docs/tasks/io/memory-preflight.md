...
`docs/progress/_unassigned.md`). The expensive streaming/tiled half is a
**separate, evaluate-first task**: [streaming-tiled-io](streaming-tiled-io.md).
...
- [Pipeline orchestration](../core/pipeline-orchestration.md) — owns `run_convert` (where
