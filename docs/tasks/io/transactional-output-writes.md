...
> **Context.** From the output-atomicity review (see
> `docs/progress/_unassigned.md`).
...
### Decisions to pin down (record in `docs/progress/io.md`)
...
- [Pipeline orchestration](../core/pipeline-orchestration.md) — owns `run_convert` and the
